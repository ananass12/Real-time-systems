...
Знакомство с базовыми механизмами организации доступа к общим ресурсам в многопоточном окружении, семафорами, условными переменными, с проблемой инверсии приоритетов и обработкой прерываний/сигналов.
...
- `src/resource_manager`: менеджерmресурсов на UNIX-сокетах и простой клиент
